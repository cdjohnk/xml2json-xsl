...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <!-- Convert XML to JSON. XML Nodes must be ordered for JSON object arrays to be properly parsed.
                 ...
                 Applying the clean4json.xsl transformation prior to this one will both clean text so it 
                 is properly escaped for JSON and order the nodes so they are properly parsed into arrays. -->
